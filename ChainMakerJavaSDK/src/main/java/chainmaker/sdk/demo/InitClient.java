...
public class InitClient {
    ...
    static final String CLIENT1_KEY_PATH = "crypto-config/chainmaker-v3.0.0-wx-org1.chainmaker.org/config/wx-org1.chainmaker.org/certs/user/client1/client1.sign.key";
    static final String CLIENT1_CERT_PATH = "crypto-config/chainmaker-v3.0.0-wx-org1.chainmaker.org/config/wx-org1.chainmaker.org/certs/user/client1/client1.sign.crt";

    static String CLIENT1_TLS_KEY_PATH = "crypto-config/chainmaker-v3.0.0-wx-org1.chainmaker.org/config/wx-org1.chainmaker.org/certs/user/client1/client1.tls.key";
    static String CLIENT1_TLS_CERT_PATH = "crypto-config/chainmaker-v3.0.0-wx-org1.chainmaker.org/config/wx-org1.chainmaker.org/certs/user/client1/client1.tls.crt";
